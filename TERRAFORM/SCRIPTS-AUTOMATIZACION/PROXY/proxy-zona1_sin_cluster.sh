...
# Variables
NOMBRE=" proxyzona1-equipo5" # NOMBRE CAMBIAR
...
backend http_back
    balance roundrobin
    server mensajeria1 10.0.3.20:80 check
...
backend https_back
    balance roundrobin
    server mensajeria1 10.0.3.20:443 check
EOF
# AGREGAR LUEGO SEGUNDA IP CLUSTER
# server mensajeria1_1 10.0.3.30:443 check
